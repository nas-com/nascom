...
$(document).ready(function() {
	...
	var form = "<form id='nascom-add-comment'><textarea></textarea><span id='nascom-copyright'>Powered by <a href='"+nascom_website+"' target='_blank'>Nascom</a></span><input type='submit' value='Comment'/></form>"
